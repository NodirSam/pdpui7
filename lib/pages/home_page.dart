              ...
              child: Row(
                children: <Widget>[
                  Container(
                    width: 100,
                    child:
                    Image(image: AssetImage('assets/images/images1.png')),
                  ),
                ],
              ),
            ),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Image(
                          width: double.infinity,
                          height: 240,
                          image: AssetImage("assets/images/images7.jpeg"),
                          fit: BoxFit.cover,
                        ),
                        SizedBox(height: 16,),
                              ...
                              Expanded(
                                child: Column(
                                  children: [
                                    ...
                                    Expanded(
                                      child: Image(
                                        image: AssetImage("assets/images/images6.jpeg"),
                                        fit: BoxFit.cover,
                                      ),
                                    ),
                                  ],
                              ...
                              Expanded(
                                child: Column(
                                  children: [
                                    Expanded(
                                      child: Image(
                                        image: AssetImage("assets/images/images5.jpeg"),
                                        fit: BoxFit.cover,
                                      ),
                                    ),
                                    SizedBox(height: 5,),
                            ...
                            children: [
                              Expanded(
                                  child: Container(
                                    width: double.infinity,
                                    child: Image(
                                      image: AssetImage("assets/images/images10.jpeg"),
                                      fit: BoxFit.cover,
                                    ),
                                  )
                              ),
                                    ...
                                    children: [
                                      ...
                                      Expanded(
                                        child: Container(
                                          color: Colors.red,
                                          child: Image(
                                            image: AssetImage("assets/images/images9.jpeg"),
                                            fit: BoxFit.cover,
                                          ),
                                        ),
                                      )
